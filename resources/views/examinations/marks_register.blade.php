                                ...
                                <table
                                    ...
                                    <tbody>
                                        @if (!empty($getStudent) && !empty($getStudent->count()))
                                            ...
                                            <form name="post" method="POST" class="submitForm" action="{{ url('examinations/submit_marks_register') }}">
                                                @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <a class="btn btn-outline-secondary" target="_blank" href="{{ url('admin/my_exam_result/print?exam_id='.Request::get('exam_id').'&student_id='.$student->id) }}">Print</a>
...
<script>
    $(document).ready(function() {
        ...
        $('.SaveSingleSubject').on('click', function(e) {
            ...
            var url = "{{ url('examinations/single_submit_marks_register') }}";
            var type = 'POST';
            var data = {
                id: id,
