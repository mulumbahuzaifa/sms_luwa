                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms calendar-icon">
                                        ...
                                        <input type="date" class="form-control  @error('date_of_birth') is-invalid @enderror" name="date_of_birth" placeholder="DD-MM-YYYY" value="{{ old('date_of_birth') }}">
                                        @error('date_of_birth')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" placeholder="Enter Phone" value="{{ old('phone_number') }}">
                                        @error('phone_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('marital_status') is-invalid @enderror" name="marital_status" placeholder="Marital Status" value="{{ old('marital_status') }}">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms calendar-icon">
                                        ...
                                        <input type="date" class="form-control  @error('join_date') is-invalid @enderror" name="join_date" placeholder="DD-MM-YYYY" value="{{ old('join_date') }}">
                                        @error('join_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4 local-forms">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('qualification') is-invalid @enderror" name="qualification" placeholder="Enter Teacher Qualifications" value="{{ old('qualification') }}">{{ old('qualification') }}</textarea>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <textarea class="form-control @error('experience') is-invalid @enderror" name="experience" placeholder="Enter Work Experience" value="{{ old('experience') }}">{{ old('experience') }}</textarea>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <textarea class="form-control @error('note') is-invalid @enderror" name="note" placeholder="Enter Some Note" value="{{ old('note') }}">{{ old('note') }}</textarea>
                                        @error('note')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="password" class="form-control pass-input @error('password') is-invalid @enderror" name="password" placeholder="Enter Password" value="{{ old('password') }}">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="password" class="form-control pass-input @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Repeat Password" value="{{ old('password_confirmation') }}">
                                        <span class="profile-views feather-eye toggle-password"></span>
                                ...
                                <div class="col-12">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('current_address') is-invalid @enderror" name="current_address" placeholder="Enter Current Address" value="{{ old('current_address') }}">
                                ...
                                <div class="col-12">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" placeholder="Enter Permanent address" value="{{ old('address') }}">
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
