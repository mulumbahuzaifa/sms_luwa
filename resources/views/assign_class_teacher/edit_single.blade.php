        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Assign Class to teacher edit</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('assign_class_teacher.list') }}">Class to teacher </a></li>
                            <li class="breadcrumb-item active">Assign Class to teacher edit</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('assign_class_teacher.update_single', $getRecord->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title"><span>Edit Class to teacher </span></h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select  @error('teacher_id') is-invalid @enderror" name="teacher_id" required>
