    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ww2div class="tab-content profile-tab-cont">
                ...
                <div class="card-body box-profile">
                  <div class="text-center">
                    ...
                    <img class="profile-user-img img-fluid img-circle"
                         src="{{ !empty(Session::get('avatar')) ? Storage::url('teacher-photos/'.Session::get('avatar')) : URL::to('images/photo_defaults.jpg') }}"
                         alt="{{ Session::get('name') }}">
                  </div>

                  <h3 class="profile-username text-center">{{ $teacher->name }} {{ $teacher->last_name }}</h3>

                  <p class="text-muted text-center">{{ $teacher->position }}</p>
