                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="search-student-btn">
                            ...
                            <a href="{{ route('admin/list/page') }}" class="btn btn-success">Reset</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-table">
                    <div class="card-body">
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Admins ({{ $listAdmin->count() }})</h3>
                                </div>
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="{{ route('admin/list/page') }}" class="btn btn-outline-gray me-2 active"><i
                                            class="feather-list"></i></a>
                                    <a href="{{ route('admin/grid/page') }}" class="btn btn-outline-gray me-2"><i
                                            class="feather-grid"></i></a>
                                    <a href="#" class="btn btn-outline-primary me-2"><i
                                            class="fas fa-download"></i> Download</a>
                                    <a href="{{ route('admin/add/page') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="admin-details.html" class="avatar avatar-sm me-2">
                                                    @if (!empty($list->avatar))
                                                        <img class="avatar-img rounded-circle" src="{{ Storage::url('admin-photos/'.$list->avatar) }}" alt="{{ $list->name }}">
                                                    @else
                                                        <img class="avatar-img rounded-circle" src="{{ URL::to('images/photo_defaults.jpg') }}" alt="{{ $list->name }}">
                                                    @endif
                                                </a>
                                                <a href="admin-details.html">{{ $list->name }} {{ $list->last_name }}</a>
                                            </h2>
                                        </td>
                                        <td>{{ $list->email }}</td>
                                        <td>{{ $list->gender }}</td>
                                        ...
                                        <td class="text-end">
                                            <div class="actions">
                                                <a href="{{ url('admin/edit/'.$list->id) }}" class="btn btn-sm bg-danger-light">
                                                    <i class="feather-edit"></i>
                                                </a>
                                                    <form action="{{ route('admin/delete', $list->id) }}" method="POST">
                                                        @csrf
                                                        {{-- @method('DELETE') --}}
                                                ...
                                                {{-- <a class="btn btn-sm bg-danger-light admin_delete" data-bs-toggle="modal" data-bs-target="#adminDelete">
                                                    <i class="feather-trash-2 me-1"></i>
                                                </a> --}}
                                            </div>
                                        </td>
...
{{-- model admin delete --}}
<div class="modal fade contentmodal" id="adminDelete" tabindex="-1" aria-hidden="true">
