        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin/fees_collection') }}">Fees</a></li>
                ...
                <div class="card card-table">
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title"> <span style="color: #20c6ba">{{ $getStudent->name }} {{ $getStudent->last_name }}</span></h3>
                                </div>
