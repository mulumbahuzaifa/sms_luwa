...
class NoticeBoardModel extends Model
{
    ...
    static public function getRecord(){
        $return = self::select('notice_board.*','users.name as created_by_name','users.last_name as created_by_last_name')
                ...
                if(!empty(Request::get('message_to'))){
                    ...
                    $return = $return->where('notice_board_message.message_to', 'like', '%'.Request::get('message_to').'%');
                }
